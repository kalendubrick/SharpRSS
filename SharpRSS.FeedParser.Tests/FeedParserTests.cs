namespace SharpRSS.FeedParser.Tests
{
    ...
    class FeedParserTests
    {
        ...
        [Test]
        public void ParsedFeedShouldMatchProvidedFeed()
        {
            var feed = new Feed()
            {
                Title = "Liftoff News",
                ...
                Language = "en-us",
                PublishDate = DateTimeOffset.Parse("Tue, 10 Jun 2003 04:00:00 GMT"),
                LastBuildDate = DateTimeOffset.Parse("Tue, 10 Jun 2003 09:41:01 GMT"),
            ...
            feed.Items.Add(new FeedItem()
            {
                ...
                PublishDate = DateTimeOffset.Parse("Tue, 03 Jun 2003 09:39:21 GMT")
            });
